% Script for extracting power in each frequency range from EEG data block with
% rows being the time course and columns being the electrode axis. Have not
% checked to see if this works yet.
%
% From: https://emotiv.com/forum/forum4/topic18214/messages/
%   Posted by: GMAC Administrator @ emotiv
%
% Assumes: 128 Hz Sampling Freq; matrix has EEG data only; no corrections!
%
% MDT
% 2016.01.18
